...
public partial class CriProfiler
{
	...
	protected enum TcpCommandId {
		...
		CRITCP_MAIL_MONITOR_ATOMEXASE_TOTAL_LEVEL_INFO,
	};
	...
	protected enum LogFuncId {
		...
		LOG_COMMAND_ExPlayer_SetPanWideness,                /* criAtomExPlayer_SetPanWideness */
		...
		LOG_COMMAND_ExAcb_AttachAwbHn,
		LOG_COMMAND_ExPlayer_StopAsync,
		LOG_COMMAND_ExPlayer_SetAdditionalVoicePoolIdentifier,
		LOG_COMMAND_ExCategory_OverrideCueLimitForGroup,
		LOG_COMMAND_ExCategory_OverrideCueLimitById,
		LOG_COMMAND_ExCategory_OverrideCueLimitByName,
		LOG_COMMAND_ExVoicePool_SetAdditionalIdentifier,
		LOG_COMMAND_ExPlayback_Removed,
		LOG_COMMAND_ExAcf_DoCreateSpatialAsrRack,
		LOG_COMMAND_ExPlayer_SetSpread,
		LOG_COMMAND_ExPlayer_SetPanAdx1Compatible,
		LOG_COMMAND_Ex3dSource_SetCuboidExtent,
		LOG_COMMAND_ExHcaMx_SetConfigForWorkSizeCalculation,
		LOG_COMMAND_ExAsr_SetRenderingPercentage,
		LOG_COMMAND_ExAcb_Decrypt,
		LOG_COMMAND_Ex3dSourceList_SetVolumeAdjustmentType,
		LOG_COMMAND_ExPlayer_Set3dSourcePlaybackPositionUpdateType,
	};
	...
	protected enum LogParamId {
		...
		LOG_STRINGS_ITEM_ExVoicePoolIdentifier,
		LOG_STRINGS_ITEM_NumLimit,
		LOG_STRINGS_ITEM_CuboidExtent,
		LOG_STRINGS_ITEM_Percentage,
		LOG_STRINGS_ITEM_Nonce,
		LOG_STRINGS_ITEM_VolumeAdjustmentType,
		LOG_STRINGS_ITEM_PlaybackPositionUpdateType,
	};
	...
	static protected readonly LogParam[] LogParams = new LogParam[] {
		...
		new LogParam("PanAngle",                   		LogParamTypes.TYPE_FLOAT32 ),				/* 280 */
		new LogParam("InteriorDistance",           		LogParamTypes.TYPE_FLOAT32 ),				/* 281 */
		new LogParam("PanType",                    		LogParamTypes.TYPE_INT32 ),					/* 282 */
		new LogParam("PanSpeakerType",             		LogParamTypes.TYPE_INT32 ),					/* 283 */
		new LogParam("PanAngleType",               		LogParamTypes.TYPE_INT32 ),					/* 284 */
		new LogParam("PanSpread",                  		LogParamTypes.TYPE_FLOAT32 ),				/* 285 */
		new LogParam("BusSendLevel",               		LogParamTypes.TYPE_FLOAT32 ),				/* 286 */
		new LogParam("LevelOffset",                		LogParamTypes.TYPE_FLOAT32 ),				/* 287 */
		new LogParam("CofHigh",                    		LogParamTypes.TYPE_FLOAT32 ),
		new LogParam("CofLow",                     		LogParamTypes.TYPE_FLOAT32 ),
		new LogParam("BiquadFilterType",           		LogParamTypes.TYPE_INT32 ),					/* 290 */
		...
		new LogParam("CurveType",                  		LogParamTypes.TYPE_INT32 ),					/* 295 */
		...
		new LogParam("DataRequestCallbackFunc",    		LogParamTypes.TYPE_UINTPTR ),				/* 300 */
		...
		new LogParam("ExPlaybackCallback",         		LogParamTypes.TYPE_UINTPTR ),				/* 305 */
		...
		new LogParam("PlaybackRatio",              		LogParamTypes.TYPE_FLOAT32 ),				/* 310 */
		...
		new LogParam("ChannelsPerTrack",                LogParamTypes.TYPE_INT32ARRAY ),			/* 315 */
		...
		new LogParam("SpeakerId",                  		LogParamTypes.TYPE_INT32 ),					/* 320 */
		...
		new LogParam("ChannelConfig",              		LogParamTypes.TYPE_INT32 ),					/* 325 */
		...
		new LogParam("MaxAttenuationDistance",     		LogParamTypes.TYPE_FLOAT32 ),				/* 330 */
		...
		new LogParam("Ex3dSourceRandomPositionConfig", 	LogParamTypes.TYPE_UINTPTR ),				/* 335 */
		...
		new LogParam("Ex3dRegionConfig",           		LogParamTypes.TYPE_UINTPTR ),				/* 340 */
		...
		new LogParam("ExCueLiniCallback",          		LogParamTypes.TYPE_UINTPTR ),				/* 345 */
		...
		new LogParam("ExVoiceEventCallback",       		LogParamTypes.TYPE_UINTPTR ),				/* 350 */
		...
		new LogParam("ExAcbHandleCallback",        		LogParamTypes.TYPE_UINTPTR ),				/* 355 */
		...
		new LogParam("Ex3dSoundObjectConfig",      		LogParamTypes.TYPE_UINTPTR ),				/* 360 */
		...
		new LogParam("PanInfoDistance",            		LogParamTypes.TYPE_FLOAT32 ),				/* 365 */
		...
		new LogParam("SendToBusName",              		LogParamTypes.TYPE_CHAR ),					/* 370 */
		...
		new LogParam("ExAsrBusPreFilterCallback",  		LogParamTypes.TYPE_UINTPTR ),				/* 375 */
		...
		new LogParam("OutputRackId",               		LogParamTypes.TYPE_INT32 ),					/* 380 */
		...
		new LogParam("ExOutputPortConfig",         		LogParamTypes.TYPE_UINTPTR ),				/* 385 */
		...
		new LogParam("SpatializerType",            		LogParamTypes.TYPE_INT32 ),					/* 390 */
		...
		new LogParam("DirectAuiodRadius",          		LogParamTypes.TYPE_FLOAT32 ),				/* 395 */
		new LogParam("CrossfadeDistance",          		LogParamTypes.TYPE_FLOAT32 ),				/* 396 */
		new LogParam("PreviewRackType",            		LogParamTypes.TYPE_INT32 ),					/* 397 */
		...
		new LogParam("ExVoicePoolIdentifier", 			LogParamTypes.TYPE_INT32 ),				   /* 481 */
		new LogParam("NumLimit",						LogParamTypes.TYPE_INT32 ),				   /* 482 */
		new LogParam("CuboidExtent",					LogParamTypes.TYPE_CUBOID_EXTENT ),		   /* 483 */
		new LogParam("Percentage",						LogParamTypes.TYPE_INT32 ),				   /* 484 */
		new LogParam("Nonce",							LogParamTypes.TYPE_INT64 ),				   /* 485 */
		new LogParam("VolumeAdjustmentType",			LogParamTypes.TYPE_INT32 ),				   /* 486 */
		new LogParam("PlaybackPositionUpdateType",		LogParamTypes.TYPE_INT32 ),				   /* 487 */
	};
	...
	protected const uint LOG_MODE_TIME_INFORMATION = 1 << 13;
