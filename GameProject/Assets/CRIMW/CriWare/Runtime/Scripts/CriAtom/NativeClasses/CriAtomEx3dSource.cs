...
public class CriAtomEx3dSource : CriDisposable
{
	 ...
	 * \deprecated
	 * 削除予定の非推奨APIです。
	 * CriWare.CriAtomEx3dSource.SetOrientation(Vector3, Vector3) の使用を検討してください。
	...
	/**
	 * <summary>3D音源の直方体形状パラメーター設定</summary>
	 * <param name='cuboidExtent'>直方体形状パラメーター</param>
	 * <remarks>
	 * <para header='説明'>指定した3D音源に対し、直方体の音源形状パラメーターを設定します。<br/>
	 * 直方体形状の中心は、 CriWare.CriAtomEx3dSource::SetPosition 関数で設定された3D音源の位置になります。<br/>
	 * また、直方体形状の姿勢は CriWare.CriAtomEx3dSource::SetOrientation 関数で設定された3D音源の向きに応じて回転し、<br/>
	 * 奥行き方向の辺は前方ベクトル、高さ方向の辺は上方ベクトルと平行になるように配置されます。<br/></para>
	 * <para header='備考'>指定した直方体形状パラメーターにおいてすべての辺の長さが 0.0f の場合、直方体形状機能が無効化され、3D音源は点音源として扱われます。<br/>
	 * CuboidExtent に NULL を指定した場合も同様に、直方体形状機能が無効化され、3D音源は点音源として扱われます。<br/></para>
	 * <para header='注意'>設定したパラメーターを実際に適用するには、CriWare.CriAtomEx3dSource::Update 関数を呼び出す必要があります。<br/></para>
	 * </remarks>
	 * <seealso cref='CriAtomEx::CuboidExtent'/>
	 * <seealso cref='CriAtomEx3dSource::SetPosition'/>
	 * <seealso cref='CriAtomEx3dSource::SetOrientation'/>
	 * <seealso cref='CriAtomEx3dSource::Update'/>
	 */
	public void SetCuboidExtent(CriAtomEx.CuboidExtent cuboidExtent) {
		criAtomEx3dSource_SetCuboidExtent(this.handle, ref cuboidExtent);
	}
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void criAtomEx3dSource_SetCuboidExtent(IntPtr ex_3d_source, ref CriAtomEx.CuboidExtent cuboid_extent);
#else
	...
	private static void criAtomEx3dSource_SetCuboidExtent(IntPtr ex_3d_source, ref CriAtomEx.CuboidExtent cuboid_extent) { }
#endif
